...
(function(){
  ...
  if(f){
    f.innerHTML='<div class="wrap"><div class="footer-grid">'+
      ...
      '<div><h5>Navigasi</h5><ul><li><a href="index.html">Home</a></li><li><a href="koleksi.html">Collection</a></li><li><a href="about.html">About Us</a></li><li><a href="faq.html">F.A.Q</a></li><li><a href="news.html">News</a></li><li><a href="order.html">Order Now</a></li></ul></div>'+
  ...
  (function(){
    ...
    var items=[
      ...
      ["produk.html","Collection","<svg viewBox=\"0 0 24 24\"><path d=\"M4 7h16l-1.4 13H5.4z\"/><path d=\"M8.5 7a3.5 3.5 0 017 0\"/></svg>"],
